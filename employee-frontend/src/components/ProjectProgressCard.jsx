...
export default function ProjectProgressCard({ project, progress, taskCount }) {
  return (
    <Link
      ...
      className="bg-white rounded-xl p-8 border border-outline-variant card-shadow relative overflow-hidden md:col-span-6 block hover:-translate-y-0.5 hover:shadow-md transition-all"
    >
