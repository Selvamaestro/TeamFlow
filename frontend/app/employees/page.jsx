                                    ...
                                    <tr key={employee._id}>
                                        ...
                                        <td>
                                            <div className="reward-cell">
                                                <span className="reward-score">{employee.rewardScore ?? 0}</span>
                                                {employee.rewardLevel && (
                                                    <span className={`level-badge level-${employee.rewardLevel.toLowerCase()}`}>
                                                        {employee.rewardLevel}
                                                    </span>
                                                )}
                                            </div>
                                            ...
                                            <div className="progress-wrapper">
                                                ...
                                                <div className="progress">
                                                    ...
                                                    <div
                                                        ...
                                                        style={{
                                                            width: `${Math.min(100, Math.round(((employee.attendance || 0) / 30) * 100))}%`,
                                                        }}
                                                    />
